...
<%==SIM:ForEach:Element.AllAttributes==%>
    ...
    var <%==SIM:Attribute.Name==%>: <%==SIM:Attribute.Type==%><%==SIM:If:Attribute.IsArray==%>[]<%==SIM:EndIf==%>         
...
<%==SIM:ForEach:Element.Operations==%>
    ...
    <%==SIM:If:Element.IsPublic==%>export <%==SIM:EndIf==%>function <%==SIM:Operation.Name==%> (<%==SIM:ForEach:Operation.Parameters==%><%==SIM:Parameter.Name==%>: <%==SIM:Parameter.Type==%><%==SIM:IfNot:IsLastItem==%>, <%==SIM:EndIf==%><%==SIM:EndFor==%>): <%==SIM:If:Operation.HasReturnType==%><%==SIM:Operation.ReturnType==%><%==SIM:EndIf==%><%==SIM:IfNot:Operation.HasReturnType==%>void<%==SIM:EndIf==%>
    <%==SIM:Line==%>
