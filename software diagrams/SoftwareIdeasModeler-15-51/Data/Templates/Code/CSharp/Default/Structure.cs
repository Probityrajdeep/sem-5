...
{<%==SIM:StartBlock==%><%==SIM:Line==%>
    ...
    <%==SIM:IfNot:IsEmpty(Element.Visibility)==%><%==SIM:Element.Visibility==%> <%==SIM:EndIf==%><%==SIM:If:Element.HasStereotype("readonly")==%>readonly <%==SIM:EndIf==%><%==SIM:If:Element.HasStereotype("record")==%>record <%==SIM:EndIf==%>struct <%==SIM:Element.Name==%><%==SIM:PrimaryConstructor(Element)==%>
