...
<%==SIM:EndFor==%> */<%==SIM:Line==%>
<%==SIM:EndIf==%><%==SIM:EndIf==%>
class <%==SIM:Element.Name==%><%==SIM:If:Element.HasSuperClassOrInterface==%> : <%==SIM:ForEach:Element.OutRelations.FilterByType(generalization,realization)==%> <%==SIM:Relation.Visibility==%> <%==SIM:Relation.To.Name==%><%==SIM:IfNot:IsLastItem==%>, <%==SIM:EndIf==%><%==SIM:EndFor==%><%==SIM:EndIf==%><%==SIM:Line==%>
{<%==SIM:Line==%>
...
<%==SIM:ForEach:Element.Operations.FilterByVisibility(undefined)==%>
    <%==SIM:If:Operation.IsStatic==%> static <%==SIM:EndIf==%><%==SIM:If:Or(Operation.IsVirtual,Operation.IsAbstract)==%> virtual <%==SIM:EndIf==%><%==SIM:ReturnTypeTemplate(Operation)==%> <%==SIM:Operation.Name==%> (<%==SIM:ForEach:Operation.Parameters==%><%==SIM:TypeTemplate(Parameter)==%><%==SIM:IfNot:IsLastItem==%>, <%==SIM:EndIf==%><%==SIM:EndFor==%>)<%==SIM:If:Or(Operation.IsAbstract)==%> = 0<%==SIM:EndIf==%>;<%==SIM:Line==%>
<%==SIM:EndFor==%>
 ...
 */<%==SIM:Line==%>
<%==SIM:EndIf==%><%==SIM:EndIf==%>
<%==SIM:Element.Name==%>::<%==SIM:Element.Name==%> (<%==SIM:ForEach:Constructor.Parameters==%><%==SIM:ParameterTemplate(Parameter)==%><%==SIM:IfNot:IsLastItem==%>, <%==SIM:EndIf==%><%==SIM:EndFor==%>)<%==SIM:Line==%>
{<%==SIM:StartBlock==%><%==SIM:Line==%>
 ...
 *<%==SIM:DocumentationLine==%><%==SIM:EndFor==%><%==SIM:Line==%><%==SIM:ForEach:Destructor.Parameters==%>
 * @param <%==SIM:Parameter.Name==%> <%==SIM:ToSingleLine(Parameter.Documentation)==%><%==SIM:Line==%><%==SIM:EndFor==%>
 */<%==SIM:Line==%>
<%==SIM:EndIf==%><%==SIM:EndIf==%>
<%==SIM:Element.Name==%>::~<%==SIM:Element.Name==%> (<%==SIM:ForEach:Destructor.Parameters==%><%==SIM:ParameterTemplate(Parameter)==%><%==SIM:IfNot:IsLastItem==%>, <%==SIM:EndIf==%><%==SIM:EndFor==%>)<%==SIM:Line==%>
{<%==SIM:StartBlock==%><%==SIM:Line==%>
 ...
 */<%==SIM:Line==%>
<%==SIM:EndIf==%><%==SIM:EndIf==%>
<%==SIM:ReturnTypeTemplate(Operation)==%> <%==SIM:Element.Name==%>::<%==SIM:Operation.Name==%> (<%==SIM:ForEach:Operation.Parameters==%><%==SIM:ParameterTemplate(Parameter)==%><%==SIM:IfNot:IsLastItem==%>, <%==SIM:EndIf==%><%==SIM:EndFor==%>)<%==SIM:Line==%>
{<%==SIM:StartBlock==%><%==SIM:Line==%>
