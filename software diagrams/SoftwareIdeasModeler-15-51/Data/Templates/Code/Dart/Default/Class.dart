...
<%==SIM:If:Element.IsStatic==%>static <%==SIM:EndIf==%><%==SIM:If:Element.IsLeaf==%>final <%==SIM:EndIf==%><%==SIM:If:Element.IsAbstract==%>abstract <%==SIM:EndIf==%>class <%==SIM:Element.Visibility==%><%==SIM:Element.Name==%>
...
<%==SIM:If:Element.HasSuperClassWithoutStereotypes==%> extends <%==SIM:Element.SuperClassWithoutStereotypes.Name==%><%==SIM:EndIf==%>
...
<%==SIM:If:Element.HasGeneralizations(,"mixin")==%> with <%==SIM:ForEach:Element.Generalizations(,"mixin")==%><%==SIM:Generalization.Name==%><%==SIM:IfNot:IsLastItem==%>, <%==SIM:EndIf==%><%==SIM:EndFor==%><%==SIM:EndIf==%>
<%==SIM:Line==%>
